...
st.set_page_config(page_title="MicroChat version2.0", initial_sidebar_state="collapsed")
...
# 副标题
st.markdown('<p class="subtitle">☀️  MicroChat version2.0</p>', unsafe_allow_html=True)
...
LANG_TEXTS = {
    'zh': {
        ...
        'tools': '工具',
        'language': '语言',
        'send': '给 MicroChat version2.0 发送消息',
    ...
    'en': {
        ...
        'tools': 'Tools',
        'language': 'Language',
        'send': 'Send a message to MicroChat version2.0',
...
st.session_state.max_new_tokens = st.sidebar.slider(get_text('max_length'), 256, 8192, 4096, step=1)
st.session_state.temperature = st.sidebar.slider(get_text('temperature'), 0.6, 1.2, 0.85, step=0.01)
...
# ==================== 标题区域（蜜蜂 logo） ====================
# 使用免费蜜蜂图标（Icons8）
logo_url = "https://img.icons8.com/clouds/100/000000/bee.png"
slogan = "我是 MicroChat version2.0，有什么可以帮你的？" if st.session_state.get('lang', 'en') == 'zh' else "I am MicroChat version2.0, how can I help you?"

st.markdown(
    f'<div style="display: flex; flex-direction: column; align-items: center; text-align: center; margin: 0; padding: 0;">'
    '<div style="font-style: italic; font-weight: 900; margin: 0; padding-top: 4px; display: flex; align-items: center; justify-content: center; flex-wrap: wrap; width: 100%;">'
    f'<img src="{logo_url}" style="width: 50px; height: 50px; margin-right: 10px;"> '
...
def main():
    ...
    if prompt:
        ...
        sys_prompt = [] if tools else [{"role": "system", "content": "你是MicroChat version2.0，一个乐于助人、知识渊博的AI助手。请用完整且友好的方式回答用户问题。"}]
